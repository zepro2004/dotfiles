...
export CLASSPATH=$CLASSPATH:/path/to/your/project/lib/sqlite-jdbc-3.45.1.0.jar
...
alias ls="ls --color=auto"            # Use colors (on Linux)
alias ll="ls -la"                     # Long list with hidden files
alias l="ls -lh"                      # Human-readable sizes
